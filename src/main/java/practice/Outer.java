...
Розширення або наслідування класу - це процес в результаті якого всі публічні методи  
одного класу (батьківський, базовий або суперклас) стають безпосередньо доступними в 
середині іншого класу (похідний або підклас). Окрім того підклас може додавати нові 
публічні методи або перевизначати вже існуючі методи із суперкласу.
