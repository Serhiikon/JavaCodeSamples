...
Розширення або наслідування класу - це процес в результаті якого:
    1) всі публічні методи одного класу (батьківський, базовий або суперклас) 
       стають безпосередньо доступними в середині іншого класу (похідний або підклас).
    2) підклас може додавати нові публічні методи до суперкласу.
    3) підклас може перевизначати вже існуючі методи із суперкласу.
    4) суперклас може виконувати роль інтерфейсу для свого підкласу.
